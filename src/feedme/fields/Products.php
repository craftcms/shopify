...
namespace craft\shopify\feedme\fields;
...
class Products extends Field implements FieldInterface
{
     ...
     * @var string
     */
    public static string $name = 'ShopifyProducts';
    ...
    {
        return 'shopify/_feedme/fields/products';
    }
    ...
    public function parseField(): mixed
    {
        ...
        $specialMatchCase = in_array($match, ['title', 'slug', 'shopifyId', 'id']);
